...
import imgSrc1 from "../assets/images/fusion-wear.jpg";
import imgSrc2 from "../assets/images/fusion-wear2.jpg";
    ...
    <div className="bg-[#FAF2E8]  md:px-8">
      ...
      <section id="products-container" className="px-4 md:flex md:gap-10" >
        <FusionProduct
          ...
          imgSrc={imgSrc1}
          category={"Lehenga"}
          categoryType={"Imaara velvet lehenga"}
          price={"₹999"}
        ...
        <FusionProduct
          ...
          imgSrc={imgSrc2}
          category={"Lehenga"}
          categoryType={"Lime green lehenga"}
          price={"₹999"}
          imgSet={"object-[20%_15%]"}
        />
      </section>
